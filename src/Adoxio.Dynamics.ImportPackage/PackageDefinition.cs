...
namespace Adoxio.Dynamics.ImportPackage
{
	/// <summary>
	/// Import package starter frame. 
	/// </summary>
	[Export(typeof(IImportExtensions))]
	public class PackageDefinition : ImportExtension
	{
		/// <summary>
		...
		{
			return "Dynamics 365 Import Package";
		}
		...
		public override string GetImportPackageDataFolderName
		{
			get
			{
				...
				return "Adoxio.Dynamics.ImportPackage";
			}
		}
		...
		{
			get { return "Adoxio package to import Dynamics 365 solutions and data"; }
		}
		...
		{
			get { return "Adoxio Dynamics 365 Import Package"; }
		}
	}
}
